import unittest
from advent_of_code.advent_2023.day_1.day_1 import (
    sum_calibration_values_part1,
...
class TestDay1(unittest.TestCase):
    def test_sum_calibration_values_part1(self):
        stub = ["1abc2", "pqr3stu8vwx", "a1b2c3d4e5f", "treb7uchet"]
        result = sum_calibration_values_part1(stub)
    ...
    def test_sum_calibration_values_part2(self):
        ...
        result = sum_calibration_values_part2(calibration_document)
